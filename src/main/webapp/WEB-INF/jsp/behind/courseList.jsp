        ...
        function delSpeakerById(Obj, id, name) {
            ...
            Confirm.show('温馨提示：', '确定要删除' + name + '么？', {
                'Delete': {
                    ...
                    'callback': function () {
                        var param = {"id": id};
                        $.post("courseDel", param, function (data) {
                            if (data == 'success') {
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        ...
        <a href="${pageContext.request.contextPath}/course/showCourseList?pageNum=${page.navigateFirstPage}">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="${pageContext.request.contextPath}/course/showCourseList?pageNum=${page.prePage}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="${pageContext.request.contextPath}/course/showCourseList?pageNum=${page.nextPage}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="${pageContext.request.contextPath}/course/showCourseList?pageNum=${page.navigateLastPage}">尾页</a>
    </div>
</div>
</body>
